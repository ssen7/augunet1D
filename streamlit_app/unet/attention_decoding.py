...
from .decoding import DecodingBlock
...
### Code borrowed from https://github.com/sfczekalski/attention_unet/blob/master/model.py ###
...
class AttnDecodingBlock(nn.Module):
    def __init__(
            self,
            in_channels_skip_connection: int,
            dimensions: int,
