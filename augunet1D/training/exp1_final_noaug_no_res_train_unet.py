## Notes
# No mixed precision
# Augmentations not applied during training
...
if __name__=='__main__':
    ...
    train_dataset, val_dataset=torch.utils.data.random_split(unaug_dataset, [0.95, 0.05], generator=generator)
    ...
    csv_logger = CSVLogger(save_dir="/home/ss4yd/time_segmentation/SWDUNet/checkpoints/", name=f"exp1_final_noaug_no_res")
    ...
    trainer.fit(
        ...
        # ckpt_path='./checkpoints/exp1_final_noaug/version_0/checkpoints/epoch=18-val_loss=0.22-step=97679.00.ckpt'  # uncomment to resume training from a checkpoint
    )
