...
if __name__=='__main__':
    ...
    data_10_percent=torch.utils.data.random_split(aug_dataset, [0.1, 0.9], generator=generator)
    train_dataset, val_dataset=torch.utils.data.random_split(data_10_percent[0], [0.95, 0.05], generator=generator)
    ...
    csv_logger = CSVLogger(save_dir="/home/ss4yd/time_segmentation/SWDUNet/checkpoints/", name=f"exp1_final_aug_10percent")
