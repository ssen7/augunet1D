...
if __name__=='__main__':
    ...
    data_90_percent=torch.utils.data.random_split(aug_dataset, [0.90, 0.10], generator=generator)
    train_dataset, val_dataset=torch.utils.data.random_split(data_90_percent[0], [0.95, 0.05], generator=generator)
    ...
    csv_logger = CSVLogger(save_dir="/home/ss4yd/time_segmentation/SWDUNet/checkpoints/", name=f"exp1_final_aug_90percent")
